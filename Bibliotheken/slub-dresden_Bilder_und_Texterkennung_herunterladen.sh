...
function dieseNetzQuelleApiXmlHtmlSeite () {
  ...
  printf "https://digital.slub-dresden.de/data/kitodo/${BIB_CODE_NUMER}/${BIB_CODE_NUMER}_ocr/%0${GanzahlStellen}d.xml" $dieseNummer
}
...
function dieseNetzQuelleGroesstmoeglichesBild () {
  ...
  # https://digital.slub-dresden.de/data/kitodo/sibebuvod_278555764/sibebuvod_278555764_tif/jpegs/00000675.tif.original.jpg
  printf "https://digital.slub-dresden.de/data/kitodo/${BIB_CODE_NUMER}/${BIB_CODE_NUMER}_tif/jpegs/%0${GanzahlStellen}d.tif.original.jpg" $dieseNummer
